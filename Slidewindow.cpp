...
//    XGetWindowProperty(disp,w,atom,0,500,False,AnyPropertyType,&retType,&formatReturned,&itemsReturned,&bytesReturned,&values);
    ...
    if(strncmp(t_name,"__SLIDE__",9) != 0)
    {
        ...
        XSetStandardProperties(d,wndDecoration,"__SLIDE__Deco","__SLIDE__Deco",None,NULL,0,NULL);
        ...
        XSetStandardProperties(d,wndClose,"__SLIDE__Close","__SLIDE__Close",None,NULL,0,NULL);
        ...
        XSetStandardProperties(d,wndMaximize,"__SLIDE__Maxi","__SLIDE__Maxi",None,NULL,0,NULL);
